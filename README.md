...
```
cd existing_repo
git remote add origin https://gitlab.com/geeztech/ecommerce-project/ecommerce-backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/geeztech/ecommerce-project/ecommerce-backend/-/settings/integrations)
